// For the moment, this is the testing ground to figure out how to 
// get the LED's to "fade" from one colour to another. 
...
// startIndex (Speed) : Handles the speed at which the pattern traverses leds. Increase to make the sequence repeat faster
